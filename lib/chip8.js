...
function loadsAndAdd(self, code, nv) {
    ...
    if ((code & 0x00ff) == 0x0033) {
        ...
        self.memory[self.i] = value3;
        self.memory[self.i + 1] = value2;
        self.memory[self.i + 2] = value1;
    }
}

function loadRegister(self, code, nv) {
    self.v[nv] = code & 0xff;
}
